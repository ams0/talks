...
optimisation knobs (30), HAMi (37), the one-box K3s build (41), plus a second sources slide (51).

**Slides that build.** 16, 36, 42, 43, 44 and 47 reveal one item per click. Right arrow (or space, or
...
**Timing.** Delivered in full the deck runs **≈33 min**. The technical middle (24–30) is twelve of those
...
**Cut order if you are behind: 43 → 38 → 23 → 19 → 30 → 8.** Never cut 25, 29, 41 or 42. If you
are badly behind at slide 31, jump straight to 35 with "Europe is building the bottom layer; I'll skip
the megawatts" — the technical room already believes the supply side is arriving.

**The morning of the talk.** agentgateway and llm-d both ship monthly. The versions on 26, 27, 28 and 51
...
**2 · Title.** One line. "I build AI infrastructure for a living. I want to argue that the most
important AI decision you'll make this year isn't which model — it's whose jurisdiction you run it in.
And then I want to show you the stack that lets you choose."
...
## 03 The stack is ready — 13 min (slides 20–34)

**Change your voice.** Sections 01–02 were risk; this is the part they came for. Twelve minutes for
24–30. Point, don't read; every code panel has its source in the footer.
...
**24 · Reference architecture ★rebuilt.** Sixty seconds, the map for the next six slides. Eight layers;
...
complexity." *Cut if short* — 29 carries the point on its own.

**31–34 · The build-out.** Ninety seconds total. "The bottom bar is live this month, twenty kilometres
...
## 04 What the keynote leaves out — 7 min (slides 35–43)

Credibility section. Do not rush, do not soften.

**36 · Four failure modes (builds).** "I've watched two teams fight over eight GPUs for six weeks. No
technology fixed it. A quota policy and one uncomfortable meeting fixed it." Then: "The technical half
is the next slide."

**37 · HAMi ★new.** Ninety seconds. "Kubernetes hands out GPUs as whole integers. An embedding model
...
**38 · Open source is the floor.** *Cut if short.* "If you adopt an open stack and fund none of it, you
...
**39–40 · Economics.** Same H100: $0.21 to $15.25 per million output tokens. Give permission not to
self-host: "€4,000 a month and spiky is a hobby. Come back at €40,000 and flat."

**41 · One 8×B300 box, K3s ★new.** Two minutes; slow down on step four. "K3s is right here for the same
...
## 06 Questions — 10–12 min (slides 47–49)
...
numbers are on 29 and the sources on 51.
